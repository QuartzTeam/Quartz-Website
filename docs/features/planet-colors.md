...
Recolors the planets and their tails, overriding whatever a level's own events or skin would otherwise set.

## Where to find it

Open the Quartz menu in-game and pick **Visuals → Planet Colors** from the sidebar.
