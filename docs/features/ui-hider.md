...
Hides individual pieces of the game's own on-screen UI — difficulty icon, judgement text, miss indicators, and more — independently for normal play versus recording.
...
UI Hider keeps two separate sets of hide flags:
